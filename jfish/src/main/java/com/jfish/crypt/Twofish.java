...
//...........................................................................
    ...
    private static final int OUTPUT_WHITEN = BLOCK_SIZE / 4;
    ...
    */
    ...
    public byte[] encryptArray(byte[] message, int offset, Object key) throws CryptoException {
        ...
        if (numOfPads != BLOCK_SIZE) {
            ...
            result = Util.addByteArrays(encryptBlock(last, offset, key), encryptBlock(pads, offset, key));
            return result;
        }

        result = Util.addByteArrays(result, encryptBlock(last, offset, key));
