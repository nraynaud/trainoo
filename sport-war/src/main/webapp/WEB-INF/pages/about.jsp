...
<p:layoutParams title="À propos de Trainoo.com"/>
...
<div class="block aboutBlock">
    <div class="content textContent">
        ...
        <h2>À propos de vos données personnelles</h2>

        <p>
            Vous disposez d'un droit d'accès et de rectification pour les données vous concernant. Toutes vos données
            sont
            consultables par vous-même directement sur le site. Elles ne feront pas l'objet d'un transfert à des
